<!--
Vendored from https://github.com/Disservin/fastchess/blob/master/man.md
on 2026-08-18 (fastchess ~v1.8.2). The upstream page is authoritative; re-sync
this copy only if flag behaviour changes.
-->
...
- `-ping-ms N`
    Set the maximum time to wait for engine ping responses in milliseconds, this is everything else which doesn't fit into the above categories. Default is 60000.
